...
// ============= НАСТРОЙКИ =============
// --- ESP -----------------------------
#define ESP_MODE              (0U)                          // 0U - WiFi точка доступа, 1U - клиент WiFi (подключение к роутеру)
...
#define MATRIX_LEVELS         2
//#define WIDTH2                (4U)
//#define HEIGHT2               (4U)
//#define MATRIX_TYPE2          (1U)                          // тип матрицы: 0 - зигзаг, 1 - параллельная
//#define CONNECTION_ANGLE2     (0U)                          // угол подключения: 0 - левый нижний, 1 - левый верхний, 2 - правый верхний, 3 - правый нижний
//#define STRIP_DIRECTION2      (1U)                          // направление ленты из угла: 0 - вправо, 1 - вверх, 2 - влево, 3 - вниз
